...
<body>
    <nav>
        <span>Halo, <strong><?php echo $username; ?></strong> (<?php echo strtoupper($role); ?>)</span>
    ...
    <div class="centered-wrapper">
        <div class="glass-card" style="max-width: 700px;">
            ...
            <div style="background: rgba(255,255,255,0.4); padding: 25px; border-radius: 20px; margin-top: 20px; text-align: left;">
                ...
                <p>Kami akan merilis game terbaru di akhir bulan ini. Pantau terus trailer resminya!</p>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        function checkMembership() {
            ...
            if (role === 'guest') showModal("Akses Ditolak", "Silakan login dulu untuk akses area ini.");
